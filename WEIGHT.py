...
CONNECTED = False
clientname=""
WEIGHT_topic = 'pr/home/5976397/weight'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePublisherTopic.setText(WEIGHT_topic)
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        print('Next update')
        # between 3.1 - 3.7
        wei= 3.1 + random.randrange(0, 13) * 0.05 
        wei= round(wei, 2)
        current_data ='Weight: '+str(wei)
        self.connectionDock.Weight.setText(str(wei))
        self.mc.publish_to(WEIGHT_topic,current_data)
